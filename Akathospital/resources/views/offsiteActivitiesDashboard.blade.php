...
<main class="content px-3 py-2 mt-3 ">
    <div class="container-fluid">
            ...
            <div class="col-lg-12">
                <div class="card shadow">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#addOffsiteActivitiesModal"><i class="bi-plus-circle me-2"></i> เพิ่มข้อมูลกิจกรรมนอกพื้นที่</button>
                    </div>
        ...
        <div class="modal fade" id="addOffsiteActivitiesModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
        ...
        <div class="modal fade" id="editOffsiteActivitiesModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
