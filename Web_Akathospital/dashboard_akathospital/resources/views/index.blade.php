...
<div class="container mb-5">
    <div class="row">
        <div class="col-4">
            <div class="accordion" style="width: 400px;" id="accordionExample" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <div class="accordion-body">
                            <ul>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="http://192.168.2.7/backoffice" target="_blank">BackOffice</a>
                                </li>
                                <li style="list-style: none;" class="mt-2"> 
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="http://192.168.2.3:8082/#/login" target="_blank">SMART REFER</a>
                                </li>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="http://ae.moph.go.th/isonline/" target="_blank">IS ONLINE</a>
                                </li>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="https://www.kaotajai.com/login" target="_blank">ก้าวท้าใจ</a>
                                </li>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="http://203.157.177.6/archives/" target="_blank">ระบบสารบัญ'สาสุข</a>
                                </li>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="https://snk.hdc.moph.go.th/hdc/main/index_pk.php" target="_blank">HDC43แฟ้ม(จังหวัด)</a>
                                </li>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="https://skko.moph.go.th/iclaimer/main/index.php" target="_blank">โปรแกรม iclamer</a>
                                </li>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="https://r8way.moph.go.th/r8way/" target="_blank">เขตสุขภาพที่ 8</a>
                                </li>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="https://www.cgd.go.th/cs/internet/internet/%e0%b8%ab%e0%b8%99%e0%b9%89%e0%b8%b2%e0%b8%ab%e0%b8%a5%e0%b8%b1%e0%b8%81.html" target="_blank">กรมบัญชีกลาง</a>
                                </li>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="http://www.gprocurement.go.th/new_index.html" target="_blank">ระบบจัดซื้อจัดจ้างภาครัฐ</a>
                                </li>
                                <li style="list-style: none;" class="mt-2">
                                    <a class="btn btn-warning" style="text-decoration: none; width: 280px;" href="https://coop-online.phsncoop.com/" target="_blank">สหกรณ์ออมทรัพย์สาธารณสุขสกลนคร</a>
                                </li>
                            </ul>
                        </div>
                    </div>
