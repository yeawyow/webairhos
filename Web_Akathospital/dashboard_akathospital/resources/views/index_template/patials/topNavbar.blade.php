<div class="background top-Navbar">
    <div class="container pb-5 ">
        <div class="pt-5 d-flex justify-content-center align-items-center">
            ...
            <div class="container_bottom">
                <div class="typing">
                    <h2 class="ms-5 text-uppercase" >Akathospital</h2>
                </div>
                <hr class="hr ms-5" style="box-shadow: 0 0 5px 2px rgba(0, 0, 0, 0.5);">
                <div class="typingP">
                    <p class="ms-5 text-uppercase"  >Elevatinghealth,inspiringcare,aqualityhospital.</p>
                </div>
            </div>
