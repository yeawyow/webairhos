                    ...
                    <div class="card-body">
                        <table id="productsTable" class="table table-hover table-product" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-01.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                    <td>Coach Swagger</td>
                                    <td>24541</td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-02.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-03.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-04.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-05.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-06.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                    <td>Olay</td>
                                    <td>24546</td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-07.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                    <td>Ledger Nano X</td>
                                    <td>24547</td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-08.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-09.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                ...
                                <tr>
                                    <td class="py-0">
                                        <img src="{{ asset('assets/auth/images/products/products-xs-10.jpg') }}"
                                            alt="Product Image">
                                    </td>
                                    <td>Wattbike Atom</td>
                                    <td>24550</td>
                    ...
                    <div class="card-header">
                        ...
                        <div class="dropdown dropdown-chat-state">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                ...
                                <li>
                                    <a href="#" class="user-link">
                                        <img src="{{ asset('assets/auth/images/user/user-sm-05.jpg') }}"
                                            alt="User Image">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="custom-file">
                                        ...
                                        <span class="upload-image">Click here to <span class="text-primary">add product
                                                image.</span> </span>
                                    </div>
                                </div>
                            </div>
